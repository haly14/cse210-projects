...
public class Matching : Application
{
    public Matching(string answer, int points) : base(answer, points)
    {
        ...
        private void AskQuestion(string category, string[] terms, string[] definitions, string[] correctAnswers, ref int totalPoints)
        {
            ...
            for (int i = 0; i < terms.Length; i++)
            {
                ...
                {
                    if (userAnswer.ToLower() == correctAnswers[i].ToLower())
                    {
